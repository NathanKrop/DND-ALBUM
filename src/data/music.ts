...
export const albums: Album[] = [
  {
    ...
    tracks: [
      { id: "dnd-01", number: 1,  title: "Delayed Not Denied",  duration: "3:52", previewUrl: "/audio/full/Delayed, Not Denied (1) (1).wav",  downloadUrl: "/audio/full/Delayed, Not Denied (1) (1).wav",  downloadSizeMb: 8.9,  youtubeId: "usdid6RQOLA" },
      { id: "dnd-02", number: 2,  title: "Burgundy Earned",     duration: "3:40", previewUrl: "/audio/full/Burgundy Earned.mpeg",     downloadUrl: "/audio/full/Burgundy Earned.mpeg",     downloadSizeMb: 8.4,  youtubeId: "ictleMXwbFo" },
      { id: "dnd-03", number: 3,  title: "3.A.M In Nairobi",    duration: "4:05", previewUrl: "/audio/full/3.A.M In Nairobi.mpeg",    downloadUrl: "/audio/full/3.A.M In Nairobi.mpeg",    downloadSizeMb: 9.4,  youtubeId: "7P-vJH5C1jQ" },
      { id: "dnd-04", number: 4,  title: "Chayenne",            duration: "3:30", previewUrl: "/audio/full/Chayenne.mpeg",            downloadUrl: "/audio/full/Chayenne.mpeg",            downloadSizeMb: 8.1,  youtubeId: "2CKL5cOtkQ4" },
      { id: "dnd-05", number: 5,  title: "Dream-Ear",           duration: "3:44", previewUrl: "/audio/full/Dream-Ear.mpeg",           downloadUrl: "/audio/full/Dream-Ear.mpeg",           downloadSizeMb: 8.6,  youtubeId: "Ffkwc4hrMTE" },
      ...
      { id: "dnd-07", number: 7,  title: "Call It A Year",      duration: "3:22", previewUrl: "/audio/full/Call It A Year.mpeg",      downloadUrl: "/audio/full/Call It A Year.mpeg",      downloadSizeMb: 7.7,  youtubeId: "idME17uqo50" },
      { id: "dnd-08", number: 8,  title: "All On Us",           duration: "4:12", previewUrl: "/audio/full/All On Us.mp4",            downloadUrl: "/audio/full/All On Us.mp4",            downloadSizeMb: 9.7,  youtubeId: "3daKPXNweJk" },
      { id: "dnd-09", number: 9,  title: "Ordinary Unusual",    duration: "3:33", previewUrl: "/audio/full/Ordinary Unusual.mpeg",    downloadUrl: "/audio/full/Ordinary Unusual.mpeg",    downloadSizeMb: 8.1,  youtubeId: "JyvNPYSumbY" },
      { id: "dnd-10", number: 10, title: "Run It",              duration: "3:47", previewUrl: "/audio/full/Run It.mpeg",              downloadUrl: "/audio/full/Run It.mpeg",              downloadSizeMb: 8.7,  youtubeId: "ColcrqvAnzE" },
      { id: "dnd-11", number: 11, title: "Plagiarized Swag",    duration: "4:01", previewUrl: "/audio/full/Plagiarized Swag.mpeg",    downloadUrl: "/audio/full/Plagiarized Swag.mpeg",    downloadSizeMb: 9.2,  youtubeId: "DxkEpDfh1dA" },
      { id: "dnd-12", number: 12, title: "Jiu Jitsu",           duration: "2:55", previewUrl: "/audio/full/JiuJitsu.mpeg",            downloadUrl: "/audio/full/JiuJitsu.mpeg",            downloadSizeMb: 6.7,  youtubeId: "-AqWuDQbRbA" },
      { id: "dnd-13", number: 13, title: "Dont Mind Me",        duration: "3:28", previewUrl: "/audio/full/Dont Mind Me.mpeg",        downloadUrl: "/audio/full/Dont Mind Me.mpeg",        downloadSizeMb: 8.2,  youtubeId: "0vzXO4VQJDg" },
      { id: "dnd-14", number: 14, title: "Financially Horney",  duration: "3:15", previewUrl: "/audio/full/Financially Horney.mpeg",  downloadUrl: "/audio/full/Financially Horney.mpeg",  downloadSizeMb: 7.9,  youtubeId: "HEjjFLw_WoE" },
      { id: "dnd-15", number: 15, title: "Ruff Tuff",           duration: "3:56", previewUrl: "/audio/full/Ruff Tuff.mpeg",           downloadUrl: "/audio/full/Ruff Tuff.mpeg",           downloadSizeMb: 9.3,  youtubeId: "CVeVjgGqU9A" },
      { id: "dnd-16", number: 16, title: "Song Cry",            duration: "4:23", previewUrl: "/audio/full/Song Cry.mpeg",            downloadUrl: "/audio/full/Song Cry.mpeg",            downloadSizeMb: 10.1, youtubeId: "PGOz6x--0N4" },
    ],
  },
];
